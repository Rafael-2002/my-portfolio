...
const T = {
    pt: {
        ...
        'proj-realestate-desc':  'Plataforma full-stack de pesquisa imobiliária portuguesa com interface de chat alimentada por IA. Os utilizadores fazem perguntas em linguagem natural — o backend usa Google Gemini para gerar queries PostgreSQL seguras, executá-las e devolver os resultados como property cards.',
    ...
    en: {
        ...
        'proj-realestate-title': 'RealEstateAI',
        'proj-realestate-desc':  'Full-stack Portuguese real estate search platform with an AI-powered chat interface. Users ask questions in natural language — the backend uses Google Gemini to generate safe PostgreSQL queries, execute them, and return results as property cards.',
        'proj-vuln-title':   'Vulnerability Intelligence Platform',
